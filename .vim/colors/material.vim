...
elseif g:material_theme_style == 'sergii'
" olny GUI colors changed
  let s:bg = { 'gui': '#263238', 'cterm': 'none' }
  "let s:bg = { 'gui': '#000000', 'cterm': 'none' }
  "let s:bg = { 'gui': '#080008', 'cterm': 'none' }
  let s:fg = { 'gui': '#babdb6', 'cterm': 109 }
  "let s:fg = { 'gui': '#888a85', 'cterm': 109 }

  let s:line_highlight = { 'gui': '#1a2327', 'cterm': 235 }
  let s:caret = { 'gui': '#00cc00', 'cterm': 220 }
  let s:selection = { 'gui': '#2c3b41', 'cterm': 239 }
  let s:comments = { 'gui': '#555753', 'cterm': 145 }

  let s:white = { 'gui':  '#d3d7cf', 'cterm': 231 }
  let s:black = { 'gui':  '#000000', 'cterm': 232 }
  let s:red = { 'gui':    '#ef2929', 'cterm': 203 }
  let s:orange = { 'gui': '#f57900', 'cterm': 209 }
  let s:yellow = { 'gui': '#c4a000', 'cterm': 11 }
  "let s:green = { 'gui':  '#4e9a06', 'cterm': 2 } 
  let s:green = { 'gui':  '#73d216', 'cterm': 2 } 
  let s:cyan = { 'gui':   '#06989a', 'cterm': 117 }
  let s:blue = { 'gui':   '#739fcf', 'cterm': 111 }
  let s:paleblue = { 'gui': '#7a9fcf', 'cterm': 152 }
  let s:purple = { 'gui':   '#ad7fa8', 'cterm': 176 }
  let s:brown = { 'gui':    '#c17d11', 'cterm': 137 }
  let s:pink = { 'gui':     '#f07178', 'cterm': 204 }
  let s:violet = { 'gui':   '#75507b', 'cterm': 139 }
elseif g:material_theme_style == 'sergii-light'
" olny GUI colors changed
  let s:bg = { 'gui': '#eeeeec', 'cterm': 'none' }
  let s:fg = { 'gui': '#2e3436', 'cterm': 109 }
  ...
  let s:white = { 'gui':  '#d3d7cf', 'cterm': 231 }
  let s:black = { 'gui':  '#000000', 'cterm': 232 }
  let s:red = { 'gui':    '#cc0000', 'cterm': 203 }
  "let s:red = { 'gui':    '#2e3436', 'cterm': 203 }
  "let s:orange = { 'gui': '#ce5c00', 'cterm': 209 }
  let s:orange = { 'gui': '#a40000', 'cterm': 209 }
  "let s:yellow = { 'gui': '#c4a000', 'cterm': 11 }
  let s:yellow = { 'gui': '#a40000', 'cterm': 11 }
  let s:green = { 'gui':  '#4e9a06', 'cterm': 2 } 
  let s:cyan = { 'gui':   '#06989a', 'cterm': 117 }
  let s:blue = { 'gui':   '#3465a4', 'cterm': 111 }
  let s:paleblue = { 'gui': '#7a9fcf', 'cterm': 152 }
  let s:purple = { 'gui':   '#ad7fa8', 'cterm': 176 }
  let s:brown = { 'gui':    '#8f5902', 'cterm': 137 }
  let s:pink = { 'gui':     '#f07178', 'cterm': 204 }
  let s:violet = { 'gui':   '#75507b', 'cterm': 139 }
endif
...
call s:SetHighlight('Function', s:blue, '', 'bold')
